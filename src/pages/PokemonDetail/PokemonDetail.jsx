...
const PokemonDetail = () => {
  ...
  const stats = pokemonDetail?.stats.filter(stat => statsDetail.includes(stat.name.toLowerCase())); 
        ...
        {pokemonDetail && (
            <>
              ...
              <div className="container__pokemondetail-card">
                <h2 className="pokemondetail-card__title">{pokemonDetail.name}</h2>
              </div>
              <div>
              ...
              <section>
                ...
                <ul className="pokemondetail-card__list">
                    {stats.map((stat) => (
                        <li key={stat.name} className="pokemon-detail-card__item">
